...
const CreateRightPanel = ({ formState, onFormValueChange, saveNewForm }: CreateRightPanelProps) => {
        ...
        <div className="p-4 sm:ml-84 mr-84">
            ...
            <div className="p-4 border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700">
                ...
                <div className="flex justify-between">
                    ...
                    {(formState.forms != null) && <button className="bg-blue-500 text-white p-2  rounded" onClick={saveNewForm}>
                        Create Form
                    </button>}
                </div>
...
export default CreateRightPanel;
